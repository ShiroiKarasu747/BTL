...
namespace QuanLyPhongMay
{
    public partial class FrmLop : Form
    {
        ...
        private void btnSua_Click_1(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblLop SET TenLop =N'" + txtTenLop.Text.ToString() + "',SiSo=N'" + txtSiSo.Text.ToString()
        ...
        private void btnLuu_Click_1(object sender, EventArgs e)
        {
            ...
            {
                string sql = "insert into tblLop values ( '" + txtMaLop.Text + "', '" + txtSiSo.Text + "','"
                                     + txtTenLop.Text + "' )";
                MessageBox.Show(sql);
                try
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaLop.Text == "") //nếu chưa chọn cái nào
            {
